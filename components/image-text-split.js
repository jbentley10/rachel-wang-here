...
export default function ImageTextSplit() {
  return (
    <section className="image-text-split align-center my-32 md:flex md:px-12">
      <div className={`image-text-split__text-container w-6/12 text-left md:flex-initial md:pr-32`}>
        <h2 className={`image-text-split__heading text-5xl mb-6`}>Hi, I'm Rachel</h2>
