...
export default function SimpleCTA() {
  return (
    <section className="simple-cta text-center align-center mt-8 mb-12 px-12 md:px-32 lg:px-64 md:py-32">
      ...
      <div className={`simple-cta__body-container w-full md:block lg:flex`}>
        <div className={`simplme-cta__text-container mt-4 mb-10 md:pt-32 md:w-full lg:w-1/2 lg:flex-initial`}>
        ...
        <div className={`simple-cta__image-container mt-4 mb-10 md:w-full lg:w-1/2 lg:flex-initial lg:flex`}>
          <img className={`w-4/6 md:pl-16 relative lg:mb-32 lg:flex-initial absolute`} src={`../static/SVG/stand.svg`} />
          <img className={`hidden md:inline relative lg:mt-32 lg:flex-initial absolute`} src={`../static/SVG/meditate.svg`} />
        </div>
      </div>
