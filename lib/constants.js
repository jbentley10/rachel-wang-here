...
export const BLOG_NAME = 'Rachel Wang Here'
export const BLOG_AUTHOR = 'Rachel Wang'
...
export const htmlRenderingOptions = {
  ...
  renderNode: {
    [BLOCKS.PARAGRAPH]: (node, next) => `<br/><p class='text-paragraph leading-normal font-barlow'>${next(node.content)}</p>`,
    [BLOCKS.HEADING_1]: (node, next) => `<br/> <h1 class='text-h1 font-rylan text-text-color leading-none text-center'>${next(node.content)}</h1>`,
    [BLOCKS.HEADING_2]: (node, next) => `<br/> <h2 class='text-h2 font-rylan text-text-color leading-none'>${next(node.content)}</h2>`,
    [BLOCKS.HEADING_3]: (node, next) => `<br/> <h3 class='text-h3 font-rylan text-text-color leading-none'>${next(node.content)}</h3>`,
    [BLOCKS.HEADING_4]: (node, next) => `<br/> <h4 class='text-h4 font-rylan text-text-color leading-none'>${next(node.content)}</h4>`,
    [BLOCKS.HEADING_5]: (node, next) => `<br/> <h5 class='text-h4 font-rylan text-white leading-none'>${next(node.content)}</h5>`,
